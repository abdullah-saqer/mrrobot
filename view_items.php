        ...
        <div class="col-xs-12 visible-xs">
            <nav id="menu" class="navbar">
                <div class="navbar-header"><span class="dropdown-span" id="brand">Brands</span>
                    <button type="button" class="btn btn-navbar navbar-toggle" data-toggle="collapse"
                            data-target=".navbar-ex2-collapse"><i class="fa fa-bars"></i></button>
                </div>
        ...
        <div class="col-xs-12 visible-xs">
            <nav id="menu" class="navbar">
                <div class="navbar-header"><span class="dropdown-span" id="more-filter">More Filters</span>
                    <button type="button" class="btn btn-navbar navbar-toggle" data-toggle="collapse"
                            data-target=".navbar-ex3-collapse"><i class="fa fa-bars"></i></button>
                </div>
                <div class="navbar-collapse navbar-ex3-collapse collapse ">

                    <ul class="list-group">
                        <li class="list-group-item"><input type="checkbox" name="more-filter" value="inStock"
                                                           data="false">Show in Stock only
                        </li>
                        <li class="list-group-item"><input type="checkbox" name="more-filter" value="specialPrices"
                                                           data="false">Special Prices
                        </li>
                        <li class="list-group-item"><input type="checkbox" name="more-filter" value="newArrival"
                                                           data="false">New Arrivals
                        </li>
                    </ul>
                </div>
        ...
        <div class="col-xs-12 visible-xs">
            <nav id="menu" class="navbar">
                <div class="navbar-header"><span class="dropdown-span" id="price-filter">Price Filter</span>
                    <button type="button" class="btn btn-navbar navbar-toggle" data-toggle="collapse"
                            data-target=".navbar-ex4-collapse"><i class="fa fa-bars"></i></button>
                </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h4 class="panel-title">
                                <a tabindex="-1" class="accordion-toggle text-center" data-toggle="collapse"
                                   data-parent="#accordion" href="#panel1">Categories <i
                ...
                <div class="panel-group" id="accordion">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h4 class="panel-title">
                                <a tabindex="-1" class="accordion-toggle text-center" data-toggle="collapse"
                                   data-hover="collapses" data-parent="#accordion" href="#panel2">Brand <i
                ...
                <div class="panel-group" id="accordion">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h4 class="panel-title">
                                <a tabindex="-1" class="accordion-toggle text-center" data-toggle="collapse"
                                   data-hover="collapses" data-parent="#accordion" href="#panel3">More Filters <i
                                            class="fa fa-caret-down" aria-hidden="true"></i></a>
                            </h4>
                        </div>
                        <div id="panel3" class="panel-collapse collapse">
                            <div class="panel-body">
                                ...
                                <ul class="list-group">
                                    <li class="list-group-item"><input type="checkbox" name="inStock" data="false">Show
                                        in Stock only
                                    </li>
                                    <li class="list-group-item"><input type="checkbox" name="specialPrices"
                                                                       data="false">Special Prices
                                    </li>
                                    <li class="list-group-item"><input type="checkbox" name="newArrival" data="false">New
                                        Arrivals
                                    </li>
                                </ul>
                            </div>
                ...
                <div class="panel-group" id="accordion">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h4 class="panel-title">
                                <a tabindex="-1" class="accordion-toggle text-center" data-toggle="collapse"
                                   data-hover="collapses" data-parent="#accordion" href="#panel4">Price Filter <i
                                            class="fa fa-caret-down" aria-hidden="true"></i></a>
                            </h4>
                        </div>
            ...
            <div class="row" id="view-navigation">
                <div class="col-md-2 hidden-xs">
                    <div class="btn-group btn-group-sm">
                        <button type="button" id="list" class="btn btn-default" data-toggle="tooltip" title="List"
                                data-original-title="List"><i class="fa fa-th-list"></i> List
                        </button>
                        <button type="button" id="grid" class="btn btn-default  " data-toggle="tooltip" title="Grid"
                                data-original-title="Grid"><i class="fa fa-th"></i> Grid
                        </button>
                    </div>
                </div>
